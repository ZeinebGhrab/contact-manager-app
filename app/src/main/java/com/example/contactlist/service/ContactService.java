...
public class ContactService {
    ...
    public Contact modifierContact(int id, String nom, String telephone)
        ...
        Contact c = new Contact(id, capitaliser(nom.trim()), telephone.trim());
        dao.update(c);
        return c;
    }
    ...
    public void initialiserDonneesDemo() {
        // Logique métier : n'insérer les démos que si la BD est vide
        if (dao.count() == 0) {
    ...
    // ── Méthode utilitaire métier (pas UI, pas SQL) ──────────
